...
import com.returnlive.app.GoodsDetailsActivity;
...
public class GoodsFragment extends Fragment {
    ...
    Toolbar toolbar;
    @BindViews({R.id.toobar_goods_title_address, R.id.toobar_goods_title_nearby})
    TextView[] tvToobar;
    @BindView(R.id.recylerView_goods)
    RecyclerView recylerView;
    @BindView(R.id.layout_goods_more)
    AutoRelativeLayout lyMore;//更多
    @BindView(R.id.ly_goods_cartime)
    AutoRelativeLayout lyCartime;
    @BindView(R.id.tv_goods_car_time)
    TextView tvCarTime;//装车时间
    @BindView(R.id.ly_goods_start)
    AutoRelativeLayout lyStart;
    @BindView(R.id.tv_goods_start_email)
    TextView tvStart;//出发地
    @BindView(R.id.ly_goods_end)
    AutoRelativeLayout lyEnd;
    @BindView(R.id.tv_goods_end_email)
    TextView tvEnd;//目的地
    @BindView(R.id.toobar_goods_title_address)
    TextView toobarGoodsTitleAddress;
    @BindView(R.id.toobar_goods_title_nearby)
    ...
    private void initRecyclerViewAdapter() {
        ...
        goodsAdapter = new GoodsAdapter(getActivity(), list);
        ...
        //设置监听
        goodsAdapter.setonNewItemClickListener(newItemClickListener);
    }

    //item监听
    private GoodsAdapter.onNewItemClickListener newItemClickListener = new GoodsAdapter.onNewItemClickListener() {
    ...
    //按钮监听
    @OnClick({R.id.toobar_goods_title_address, R.id.toobar_goods_title_nearby})
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.toobar_goods_title_address://标题地址
                //设置标题选择状态和字体颜色更改
                tvToobar[0].setSelected(true);
                break;
            case R.id.toobar_goods_title_nearby://标题附近
                //设置标题选择状态和字体颜色更改
