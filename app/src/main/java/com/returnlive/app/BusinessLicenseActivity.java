...
public class BusinessLicenseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap =  intent.getParcelableExtra("BusinessLicense");
        imgBusinessLicense.setImageBitmap(bitmap);
    }

    @OnClick({R.id.img_backBusiness_license, R.id.tv_savesBusiness_license, R.id.img_Business_license})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_backBusiness_license:
                finish();
                break;
            case R.id.tv_savesBusiness_license:
                finishBitmap(imgBusinessLicense,"imgBusinessLicense",31);
                break;
