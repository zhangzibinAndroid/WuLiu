...
public class DoorHeadActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_door_head);
        ...
        Bitmap bitmap =  intent.getParcelableExtra("DoorHead");
        imgDoorHead.setImageBitmap(bitmap );
    }

    @OnClick({R.id.img_backdoor_headd, R.id.tv_savesdoor_head, R.id.img_door_head})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_backdoor_headd:
                finish();
                break;
            case R.id.tv_savesdoor_head:
                finishBitmap(imgDoorHead,"imgDoorHead",29);
                break;
            case R.id.img_door_head:
                showChoosePicDialog(getResources().getString(R.string.door_head));
                break;
        }
    }

    private void finishBitmap(ImageView imageView,String key,int resultCode){
