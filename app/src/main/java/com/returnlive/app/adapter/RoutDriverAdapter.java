...
public class RoutDriverAdapter extends RecyclerView.Adapter<RoutDriverAdapter.MyViewHolder> {

    private List<RoutDriver> myList;
    private Context context;

    public RoutDriverAdapter(Context context, List<RoutDriver> list) {
