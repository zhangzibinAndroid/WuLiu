...
public class BusinessCardActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap bitmap =  intent.getParcelableExtra("BusinessCard");
        imgBusinessCard.setImageBitmap(bitmap);

    }

    @OnClick({R.id.img_backBusinessCard, R.id.tv_savesBusinessCard, R.id.img_businessCard})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.img_backBusinessCard:
                finish();
                break;
            case R.id.tv_savesBusinessCard:
                finishBitmap(imgBusinessCard,"BusinessCardReturn",27);
                break;
            case R.id.img_businessCard:
